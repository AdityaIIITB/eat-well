...
public class SampleAlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) { 
    	MainActivity.pref = context.getSharedPreferences("LatLng",Context.MODE_PRIVATE);
...
//    	GPSTracker gps = new GPSTracker(this);
        ...
        Log.i("test-test-test-test","gecgkeviglivhflvhel,vhflvhlvhe.vhe.fvhef,vhf,hvfvflvflhvhf");
